...
public class MedicationController {
    ...
    //添加用药记录
    @GetMapping("/add")
    public Result addMedication(String userId, String medicineName, String startTime, String endTime, String frequency, String medicineDose, String beforeBp, String afterBp) {
        try {
            medicationService.addMedication(userId, medicineName, startTime, endTime, frequency, medicineDose, beforeBp, afterBp);
